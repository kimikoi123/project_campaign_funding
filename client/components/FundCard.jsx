...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
  ...
  return (
    <div className="sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer" onClick={handleClick}>
      <Image src={image} width={1000} height={1000}  alt="fund" className="w-full h-[158px] object-cover rounded-[15px]"/>

      <div className="flex flex-col p-4">
        <div className="flex flex-row items-center mb-[18px]">
          <Image src={tagType} width={1000} height={1000} alt="tag" className="w-[17px] h-[17px] object-contain"/>
        ...
        <div className="flex items-center mt-[20px] gap-[12px]">
          <div className="w-[30px] h-[30px] rounded-full flex justify-center items-center bg-[#13131a]">
            <Image src={thirdweb} width={1000} height={1000} alt="user" className="w-1/2 h-1/2 object-contain"/>
          </div>
